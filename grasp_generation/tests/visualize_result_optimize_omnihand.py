...
if __name__ == '__main__':
    ...
    parser.add_argument('--object_code', type=str, default='0_024_bowl')
    parser.add_argument('--num', type=int, default=0)
    parser.add_argument('--result_path', type=str, default='/home/guizhewei/guizhewei/DexGraspNet/data/experiments/oldpen_6w/results')
    ...
    if 'energy' in data_dict:
        ...
        result = f'Index {args.num}  E_fc {E_fc}  E_dis {E_dis}  E_pen {E_pen}  E_spen {E_spen}  E_joints {E_joints}'
